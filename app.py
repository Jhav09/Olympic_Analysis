...
try:
    if not os.path.exists('athlete_events.csv'):
        st.error("Missing 'athlete_events.csv' file. Please upload the Olympic athletes dataset.")
        st.stop()
    
    if not os.path.exists('noc_regions.csv'):
        st.error("Missing 'noc_regions.csv' file. Please upload the NOC regions dataset.")
        st.stop()
